	...
	render() {
		return (
			<FormAvailPto>
                ...
                <Input name='date' value={this.setState.date} onChange={this.handleInputChange} />
                <Input name='starttime' value={this.setState.starttime} onChange={this.handleInputChange} />
                <Input name='endtime' value={this.setState.endtime} onChange={this.handleInputChange} />
