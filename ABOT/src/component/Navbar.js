...
const RequestOffStack = createStackNavigator(
	{
		...
		RequestOff: {
			screen: RequestOff,
			navigationOptions: { tabBarVisible: true, title: "R E Q U E S T" }
		}
	},
	{
...
const SchedulePageStack = createStackNavigator(
	{
		...
		SchedulePage: {
			screen: SchedulePageScreen,
			navigationOptions: { tabBarVisible: true, title: "S C H E D U L E" }
		}
	},
	{
		//For React Navigation 2.+ change defaultNavigationOptions->navigationOptions
...
// SchedulePageStack.navigationOptions = RequestOffStack.navigationOptions = ({
// 	navigation
// }) => {
...
const NavBar = createBottomTabNavigator(
	{
		...
		Avail: {
			...
			navigationOptions: {
				...
				tabBarIcon: ({ tintColor }) => (
					<Ionicons name='ios-time' size={25} color={tintColor} />
				)
			}
		},
